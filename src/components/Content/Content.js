...
const Content = () => {
  ...
  return (
    <section className="md:flex">
      <div className="ml-[70px] mr-[54px] text-bold flex flex-col items-center shadow-md bg-gradient-to-b from-white/40 rounded-[24px] to-transparent md:w-[20%]">
      ...
      <div className="flex flex-col text-13 w-[100%] mt-[90px] md:mt-0 font-semibold md:w-[30%] md:text-16 md:ml-[20%]">
